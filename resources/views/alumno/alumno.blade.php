             ...
             <div class="col-md-15">
                 <form method="POST" action="/registro" id="formulario" class="text-center p-4">
                     ...
                     <h2 class="form-maestro">Registro de Alumno</h1>
                         ...
                         <br>
                         <i class="icono fa fa-credit-card text-dark "></i> <input type="text" name="Matricula"
                             id="Matricula" placeholder="00-00-0000">
                         <br>
