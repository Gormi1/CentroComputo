...
@section('content')
    ...
    <section>
        <form method="POST" action="/registro" id="formulario">
            ...
            <br>
            <span class="fas fa-id-card"></span> <input type="text" name="Matricula" id="Matricula"
        ...
        <div class="dispCompu"> <span class="fa fa-laptop fa-6x"></span> <button><a
                    href="{{ url()->previous() }}">Regresar</a></button></div>
