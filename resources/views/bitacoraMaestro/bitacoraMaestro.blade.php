            ...
            <div class="col-md-15">
                <form method="POST" action="/registroMaestro" id="formulario" class="text-center p-4">
                    ...
                    <h2 class="form-maestro">Datos del grupo</h1>
                        <br>
                        <i class="icono fas fa-group text-dark "></i> <input type="text" name="Grupo"
                            id="Grupo"placeholder="Grupo">
                        <br>
                        <i class="icono fas fa-assignament text-dark "></i> <input type="text" name="Materia"
                            id="Materia" placeholder="Materia">
                        <br>
                        <i class="icono fas fa-user  text-dark "></i> <input type="text" name="NumAlumno" id="NumAlumno"
                            placeholder="Numero de alumnos">
                        <br>
                        <i class="icono  fas fa-clock text-dark "></i> <input type="time" name="HoraSalida" id="HoraSalida"
