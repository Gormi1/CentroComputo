        ...
        <div class="container-fluid">
            <div class="container-fluid">
                ...
                <div class="flex-grow-1 ">
                    <button class="btn btn-danger float-end" onclick="regresoSala()">Regresar a sala</button>
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <div><i class="icono fas fa-clock text-dark"></i>
                                    ...
                                    <input type="datetime-local" name="HoraEntrada" id="HoraEntrada"
                                        value="2023-01-01T08:00">
                                </div>
