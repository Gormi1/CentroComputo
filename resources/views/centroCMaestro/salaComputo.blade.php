...
@section('content')
    ...
    <div class=" contenedor d-flex justify-content-between mx-auto" style="width: 600px; padding-top:60px;">
        ...
        <div id="alum" class=" alum text-center" style="" id="mi_div">
            ...
            <br><br>
            {{-- <button class="btn-acs-maestro" id=" d-flex align-items-center justify-content-center"> <a class="a-white"
                    href="{{ route('bitacoraMaestro.index') }}">Seleccionar Aula</a> </button> --}}

            {{-- boton del ingresar para apartar un equipo --}}
            <a class=" text-center  " href="{{ route('bitacoraMaestro.index') }}"><span class=" ">
                    <button class="btn-acs-maestro" id=" d-flex align-items-center justify-content-center" value="ocupado"
                        name="estado">
                        Seleccionar aula
                    </button>
            </a>
