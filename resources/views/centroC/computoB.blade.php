...
@section('content')
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <div class="row">
                ...
                <div class=" text-center  bg-red">
                    <button class="boton-Inicio"> <a class=" home a text-center text-dark "href="{{ url('/') }}"><span
                                style="color: white" class="fa fa-home ">Inicio</span></a></button>
                    <img class="pt-2"
            ...
            <div class="d-flex justify-content-between w-100">
                ...
                <div class=" text-white text-center " style="width: 33.33%;">
                    {{-- boton de la sala A --}}
                    <a class="a text-center  " href="{{ route('computo.index') }}"><span
                            class="lap fa fa-laptop fa-3x P-2 ">
                            <br> <button class="btn btn-secondary active:border border-solid border-gray-500 active:bg-gray-200">Sala A</button>
                    </a>
                    {{-- boton de la computo B --}}
                    <a class="a  text-center " href="{{ route('computoB.index') }}"><span
                            class="lap fa fa-laptop fa-3x P-2  ">
                            <br> <button class="btn btn-success active:border border-solid border-gray-500 active:bg-gray-200">Sala B</button>
                    </a>
    ...
    <div class="container ">
        ...
        <div class="box"><span class="fa fa-laptop fa-2x " value="1"></span>1</div>
        ...
        <div class="box"><span class="fa fa-laptop fa-2x "></span>25</div>
        <div class="box"><span class="fa fa-laptop fa-2x "></span>26</div>
        <div class="box"><span class="fa fa-laptop fa-2x "></span>27</div>
        <div class="box"><span class="fa fa-laptop fa-2x "></span>28</div>
        <div class="box"><span class="fa fa-laptop fa-2x "></span>29</div>
        <div class="box"><span class="fa fa-laptop fa-2x "></span>30</div>
        <div class="box"><span class="fa fa-laptop fa-2x "></span>31</div>
        <div class="box"><span class="fa fa-laptop fa-2x "></span>32</div>
    </div>
    </div>
    </div>
    <script>
